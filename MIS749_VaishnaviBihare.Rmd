...
#Let's do overallQual next, as it is impotant to understand the how sale price is affected by the Overall Quality
...
PoolQC,GrLivArea, X2stFlrSF,GarageCars,OverallQual,KitchenQual,BsmtQual,OverallCond,X1stFlrSF,
